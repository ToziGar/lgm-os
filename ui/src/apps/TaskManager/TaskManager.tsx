...
const BASE_PROCS: Omit<Process, 'cpu' | 'mem' | 'memPct'>[] = [
  ...
  { pid: 145,  name: 'syslogd',       user: 'root',  status: 'running',  command: '/usr/sbin/syslogd -n',          started: '00:00:02', threads: 1  },
  { pid: 320,  name: 'dbus-daemon',   user: 'root',  status: 'sleeping', command: '/usr/bin/dbus-daemon --system', started: '00:00:03', threads: 1  },
  ...
  { pid: 810,  name: 'rsyslogd',      user: 'root',  status: 'running',  command: '/usr/sbin/rsyslogd -n',         started: '00:00:06', threads: 4  },
  ...
  { pid: 1350, name: 'node',          user: 'admin', status: 'running',  command: 'node /opt/lgm/server.js',       started: '00:00:15', threads: 8  },
  { pid: 1500, name: 'lgm-ui',        user: 'admin', status: 'running',  command: '/opt/lgm/ui/server',            started: '00:00:16', threads: 4  },
  { pid: 1820, name: 'avahi-daemon',  user: 'avahi', status: 'running',  command: 'avahi-daemon: running',         started: '00:00:20', threads: 2  },
  { pid: 2010, name: 'containerd',    user: 'root',  status: 'running',  command: '/usr/bin/containerd',           started: '00:01:30', threads: 14 },
  { pid: 2105, name: 'dockerd',       user: 'root',  status: 'running',  command: '/usr/bin/dockerd -H fd://',     started: '00:01:32', threads: 12 },
